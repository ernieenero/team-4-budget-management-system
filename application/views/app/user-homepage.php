...
function openNav() {
  ...
  document.getElementById("main").style.paddingTop = "60px";
  document.getElementById("left-content").style.marginLeft = "0px";
}
...
function closeNav() {
  ...
  document.getElementById("left-content").style.marginLeft = "15rem";
}
</script>
</html>